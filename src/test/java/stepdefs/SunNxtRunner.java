...
@CucumberOptions(features = "classpath:features", glue = "classpath:stepdefs", plugin = { "pretty",
		"html:target/cucumber-html-report",
		"rerun:target/rerun.txt" }, tags = { "@web" }, monochrome = true)
public class SunNxtRunner extends AbstractTestNGCucumberTests {
